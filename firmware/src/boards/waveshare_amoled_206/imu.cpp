...
// Poll and hysteresis timing — matches the 2.16 port. The shared
// rotation lifecycle in main.cpp + the aspect-swap-aware display.cpp
// in this folder consume the quadrant returned by
// imu_hal_rotation_quadrant() once per loop.
