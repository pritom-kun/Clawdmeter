...
// PWR button comes from AXP2101 PKEY short-press IRQ (same wiring as the
// 2.16 — no IO expander on this board, unlike the 1.8 which routes PWR
// through XCA9554 EXIO4).
