...
Three boards are supported out of the box:
...
- [Waveshare ESP32-S3-Touch-AMOLED-2.06](https://www.waveshare.com/esp32-s3-touch-amoled-2.06.htm) — ESP32-S3R8, 2.06" 410×502 portrait AMOLED (CO5300 QSPI), FT3168 cap touch, AXP2101 PMU, QMI8658 IMU, 32 MB flash. Two buttons (BOOT + PWR), aspect-swap auto-rotation (UI rebuilds on every quadrant change to remap fonts and positions for portrait ↔ landscape). Watch form factor. Build env: `waveshare_amoled_206`.
